...
const SAFARI_I18N = {
  en: {
    ...
    replyingToLabel: "Reply to",
    editingLabel: "Editing",
    cancelAction: "Cancel",
    selectedCount: "selected",
    deleteSelectedConfirm: "Delete selected messages?",
  ...
  ru: {
    ...
    msgForwarded: "Переслано",
    msgForwardedFrom: "Переслано от",
    forwardTitle: "Переслать в…",
    forwardSearch: "Поиск чатов…",
    replyingToLabel: "Ответ",
    editingLabel: "Редактирование",
    cancelAction: "Отмена",
    selectedCount: "выбрано",
    deleteSelectedConfirm: "Удалить выбранные сообщения?",
  ...
  ua: {
    ...
    msgCopy: "Копіювати",
    msgEdit: "Редагувати",
    msgForward: "Переслати",
    msgSelect: "Вибрати",
    msgEdited: "змінено",
    msgCopied: "Скопійовано",
    msgForwarded: "Переслано",
    msgForwardedFrom: "Переслано від",
    forwardTitle: "Переслати в…",
    forwardSearch: "Пошук чатів…",
    replyingToLabel: "Відповідь",
    editingLabel: "Редагування",
    cancelAction: "Скасувати",
    selectedCount: "вибрано",
    deleteSelectedConfirm: "Видалити вибрані повідомлення?",
  ...
  fr: {
    ...
    msgCopy: "Copier",
    msgEdit: "Modifier",
    msgForward: "Transférer",
    msgSelect: "Sélectionner",
    msgEdited: "modifié",
    msgCopied: "Copié",
    msgForwarded: "Transféré",
    msgForwardedFrom: "Transféré de",
    forwardTitle: "Transférer vers…",
    forwardSearch: "Rechercher des chats…",
    replyingToLabel: "Réponse à",
    editingLabel: "Modification",
    cancelAction: "Annuler",
    selectedCount: "sélectionné(s)",
    deleteSelectedConfirm: "Supprimer les messages sélectionnés ?",
  ...
  es: {
    ...
    msgEdit: "Editar",
    msgForward: "Reenviar",
    msgSelect: "Seleccionar",
    msgEdited: "editado",
    msgCopied: "Copiado",
    msgForwarded: "Reenviado",
    msgForwardedFrom: "Reenviado de",
    forwardTitle: "Reenviar a…",
    forwardSearch: "Buscar chats…",
    replyingToLabel: "Responder a",
    editingLabel: "Editando",
    cancelAction: "Cancelar",
    selectedCount: "seleccionado(s)",
    deleteSelectedConfirm: "¿Eliminar los mensajes seleccionados?",
